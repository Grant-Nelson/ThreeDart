...
class Solid extends Shader {

  /// The name for this shader.
  static const String defaultName = "Solid";
  ...
  factory Solid.cached(Core.RenderState state) {
    Solid shader = state.shader(defaultName);
    if (shader == null) {
      shader = new Solid(state.gl);
  ...
  Solid(WebGL.RenderingContext gl): super(gl, defaultName) {
