...
/// A shader for rendering texture 2D light.
class Texture2D extends Shader {

  /// The name for this shader.
  static const String defaultName = "Texture2D";
  ...
  factory Texture2D.cached(Core.RenderState state) {
    Texture2D shader = state.shader(defaultName);
    if (shader == null) {
      shader = new Texture2D(state.gl);
  ...
  Texture2D(WebGL.RenderingContext gl): super(gl, defaultName) {
