...
/// A shader for rendering bumpy texture cube light.
class BumpyTextureCube extends Shader {

  /// The name for this shader.
  static const String defaultName = "Bumpy Texture Cube";
  ...
  factory BumpyTextureCube.cached(Core.RenderState state) {
    BumpyTextureCube shader = state.shader(defaultName);
    if (shader == null) {
      shader = new BumpyTextureCube(state.gl);
  ...
  BumpyTextureCube(WebGL.RenderingContext gl): super(gl, defaultName) {
  ...
  void setMaterial(Materials.BumpyTextureCube material) {
