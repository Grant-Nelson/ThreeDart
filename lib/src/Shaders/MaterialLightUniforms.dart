...
class UniformBarLight {
  ...
  Math.Point3 get startPoint => this._startPnt?.getPoint3() ?? Math.Point3.zero;
  ...
  Math.Point3 get endPoint => this._endPnt?.getPoint3() ?? Math.Point3.zero;
  set endPoint(Math.Point3 pnt) => this._endPnt?.setPoint3(pnt);
  Uniform3f? _endPnt;

  /// The bar light color.
  Math.Color3 get color => this._color?.getColor3() ?? Math.Color3.white();
...
class UniformDirectionalLight {
  ...
  Math.Vector3 get objectUp => this._objUp?.getVector3() ?? Math.Vector3.zero;
  set objectUp(Math.Vector3 vec) => this._objUp?.setVector3(vec);
  Uniform3f? _objUp;

  /// The directional light's right.
  Math.Vector3 get objectRight => this._objRight?.getVector3() ?? Math.Vector3.zero;
  set objectRight(Math.Vector3 vec) => this._objRight?.setVector3(vec);
  Uniform3f? _objRight;

  /// The directional light's direction.
  Math.Vector3 get objectDir => this._objDir?.getVector3() ?? Math.Vector3.zero;
  ...
  Math.Vector3 get viewDir => this._viewDir?.getVector3() ?? Math.Vector3.zero;
...
class UniformPointLight {
  ...
  Math.Point3 get point => this._point?.getPoint3() ?? Math.Point3.zero;
  set point(Math.Point3 pnt) => this._point?.setPoint3(pnt);
  Uniform3f? _point;

  /// The point light's location transformed by the view matrix.
  Math.Point3 get viewPoint => this._viewPnt?.getPoint3() ?? Math.Point3.zero;
  ...
  Math.Matrix3 get inverseViewRotationMatrix => this._invViewRotMat?.getMatrix3() ?? Math.Matrix3.identity;
  ...
  Math.Vector4 get shadowAdjust => this._shadowAdj?.getVector4() ?? Math.Vector4.zero;
...
class UniformSpotLight {
  ...
  Math.Point3 get objectPoint => this._objPnt?.getPoint3() ?? Math.Point3.zero;
  set objectPoint(Math.Point3 pnt) => this._objPnt?.setPoint3(pnt);
  Uniform3f? _objPnt;

  /// The directional light's direction.
  Math.Vector3 get objectDirection => this._objDir?.getVector3() ?? Math.Vector3.zero;
