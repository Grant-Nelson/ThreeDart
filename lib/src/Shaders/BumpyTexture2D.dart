...
/// A shader for rendering bumpy texture 2D light.
class BumpyTexture2D extends Shader {

  /// The name for this shader.
  static const String defaultName = "Bumpy Texture2D";
  ...
  factory BumpyTexture2D.cached(Core.RenderState state) {
    BumpyTexture2D shader = state.shader(defaultName);
    if (shader == null) {
      shader = new BumpyTexture2D(state.gl);
  ...
  BumpyTexture2D(WebGL.RenderingContext gl): super(gl, defaultName) {
