...
let modulePaths = {
 ...
 "web/tests/test004/test": "tests/test004/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test004/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test004__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test004/test.dart") {
          child.main();
          return true;
        }
      }
