...
let modulePaths = {
 ...
 "web/tests/test038/test": "tests/test038/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test038/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test038__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test038/test.dart") {
          child.main();
          return true;
        }
      }
