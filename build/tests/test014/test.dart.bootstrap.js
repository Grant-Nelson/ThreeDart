...
let modulePaths = {
 ...
 "web/tests/test014/test": "tests/test014/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test014/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test014__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test014/test.dart") {
          child.main();
          return true;
        }
      }
