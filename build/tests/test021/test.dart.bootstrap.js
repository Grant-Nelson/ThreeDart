...
let modulePaths = {
 ...
 "web/tests/test021/test": "tests/test021/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test021/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test021__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test021/test.dart") {
          child.main();
          return true;
        }
      }
