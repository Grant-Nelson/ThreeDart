...
let modulePaths = {
 ...
 "web/tests/test002/test": "tests/test002/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test002/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test002__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test002/test.dart") {
          child.main();
          return true;
        }
      }
