...
let modulePaths = {
 ...
 "web/tests/test027/test": "tests/test027/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test027/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test027__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test027/test.dart") {
          child.main();
          return true;
        }
      }
