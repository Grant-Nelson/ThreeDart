...
let modulePaths = {
 ...
 "web/tests/test012/test": "tests/test012/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test012/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test012__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test012/test.dart") {
          child.main();
          return true;
        }
      }
