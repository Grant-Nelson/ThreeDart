...
let modulePaths = {
 ...
 "web/tests/test035/test": "tests/test035/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test035/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test035__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test035/test.dart") {
          child.main();
          return true;
        }
      }
