...
let modulePaths = {
 ...
 "web/tests/test026/test": "tests/test026/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test026/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test026__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test026/test.dart") {
          child.main();
          return true;
        }
      }
