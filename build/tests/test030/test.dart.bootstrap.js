...
let modulePaths = {
 ...
 "web/tests/test030/test": "tests/test030/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test030/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test030__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test030/test.dart") {
          child.main();
          return true;
        }
      }
