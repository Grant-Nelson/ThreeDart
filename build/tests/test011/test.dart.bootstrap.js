...
let modulePaths = {
 ...
 "web/tests/test011/test": "tests/test011/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test011/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test011__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test011/test.dart") {
          child.main();
          return true;
        }
      }
