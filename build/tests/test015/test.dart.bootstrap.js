...
let modulePaths = {
 ...
 "web/tests/test015/test": "tests/test015/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test015/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test015__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test015/test.dart") {
          child.main();
          return true;
        }
      }
