...
let modulePaths = {
 ...
 "web/tests/test029/test": "tests/test029/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test029/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test029__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test029/test.dart") {
          child.main();
          return true;
        }
      }
