...
let modulePaths = {
 ...
 "web/tests/test032/test": "tests/test032/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test032/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test032__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test032/test.dart") {
          child.main();
          return true;
        }
      }
