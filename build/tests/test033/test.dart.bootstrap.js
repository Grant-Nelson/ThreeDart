...
let modulePaths = {
 ...
 "web/tests/test033/test": "tests/test033/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test033/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test033__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test033/test.dart") {
          child.main();
          return true;
        }
      }
