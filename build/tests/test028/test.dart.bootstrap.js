...
let modulePaths = {
 ...
 "web/tests/test028/test": "tests/test028/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test028/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test028__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test028/test.dart") {
          child.main();
          return true;
        }
      }
