...
let modulePaths = {
 ...
 "web/tests/test025/test": "tests/test025/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test025/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test025__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test025/test.dart") {
          child.main();
          return true;
        }
      }
