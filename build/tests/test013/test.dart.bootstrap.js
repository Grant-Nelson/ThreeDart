...
let modulePaths = {
 ...
 "web/tests/test013/test": "tests/test013/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test013/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test013__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test013/test.dart") {
          child.main();
          return true;
        }
      }
