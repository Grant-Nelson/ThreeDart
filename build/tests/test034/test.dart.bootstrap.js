...
let modulePaths = {
 ...
 "web/tests/test034/test": "tests/test034/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test034/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test034__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test034/test.dart") {
          child.main();
          return true;
        }
      }
