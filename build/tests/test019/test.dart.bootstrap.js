...
let modulePaths = {
 ...
 "web/tests/test019/test": "tests/test019/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test019/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test019__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test019/test.dart") {
          child.main();
          return true;
        }
      }
