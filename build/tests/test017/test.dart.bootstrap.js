...
let modulePaths = {
 ...
 "web/tests/test017/test": "tests/test017/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test017/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test017__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test017/test.dart") {
          child.main();
          return true;
        }
      }
