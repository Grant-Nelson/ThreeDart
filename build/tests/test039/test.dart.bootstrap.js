...
let modulePaths = {
 ...
 "web/tests/test039/test": "tests/test039/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test039/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test039__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test039/test.dart") {
          child.main();
          return true;
        }
      }
