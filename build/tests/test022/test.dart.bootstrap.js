...
let modulePaths = {
 ...
 "web/tests/test022/test": "tests/test022/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test022/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test022__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test022/test.dart") {
          child.main();
          return true;
        }
      }
