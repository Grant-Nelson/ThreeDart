...
let modulePaths = {
 ...
 "web/tests/test010/test": "tests/test010/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test010/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test010__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test010/test.dart") {
          child.main();
          return true;
        }
      }
