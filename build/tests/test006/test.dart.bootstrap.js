...
let modulePaths = {
 ...
 "web/tests/test006/test": "tests/test006/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test006/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test006__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test006/test.dart") {
          child.main();
          return true;
        }
      }
