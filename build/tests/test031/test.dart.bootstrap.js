...
let modulePaths = {
 ...
 "web/tests/test031/test": "tests/test031/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test031/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test031__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test031/test.dart") {
          child.main();
          return true;
        }
      }
