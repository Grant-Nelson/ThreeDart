...
let modulePaths = {
 ...
 "packages/ThreeDart/Shaders": "packages/ThreeDart/Shaders.ddc",
 ...
 "web/tests/test008/test": "tests/test008/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test008/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test008__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test008/test.dart") {
          child.main();
          return true;
        }
      }
