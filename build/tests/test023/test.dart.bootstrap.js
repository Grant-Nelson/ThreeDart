...
let modulePaths = {
 ...
 "web/tests/test023/test": "tests/test023/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test023/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test023__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test023/test.dart") {
          child.main();
          return true;
        }
      }
