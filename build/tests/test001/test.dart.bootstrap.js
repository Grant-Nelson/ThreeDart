...
let modulePaths = {
 ...
 "web/tests/test001/test": "tests/test001/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test001/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test001__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test001/test.dart") {
          child.main();
          return true;
        }
      }
