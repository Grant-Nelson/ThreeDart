...
let modulePaths = {
 ...
 "web/tests/test018/test": "tests/test018/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test018/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test018__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test018/test.dart") {
          child.main();
          return true;
        }
      }
