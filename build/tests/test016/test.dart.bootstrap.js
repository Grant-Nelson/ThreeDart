...
let modulePaths = {
 ...
 "web/tests/test016/test": "tests/test016/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test016/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test016__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test016/test.dart") {
          child.main();
          return true;
        }
      }
