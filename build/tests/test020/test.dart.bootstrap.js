...
let modulePaths = {
 ...
 "web/tests/test020/test": "tests/test020/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test020/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test020__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test020/test.dart") {
          child.main();
          return true;
        }
      }
