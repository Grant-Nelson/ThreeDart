...
let modulePaths = {
 ...
 "packages/ThreeDart/Views": "packages/ThreeDart/Views.ddc",
 ...
 "web/tests/test040/test": "tests/test040/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test040/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test040__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test040/test.dart") {
          child.main();
          return true;
        }
      }
