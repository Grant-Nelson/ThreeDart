...
let modulePaths = {
 ...
 "web/tests/test009/test": "tests/test009/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test009/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test009__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test009/test.dart") {
          child.main();
          return true;
        }
      }
