...
let modulePaths = {
 ...
 "web/tests/test003/test": "tests/test003/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test003/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test003__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test003/test.dart") {
          child.main();
          return true;
        }
      }
