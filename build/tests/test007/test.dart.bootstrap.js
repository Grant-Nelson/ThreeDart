...
let modulePaths = {
 ...
 "web/tests/test007/test": "tests/test007/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test007/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test007__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test007/test.dart") {
          child.main();
          return true;
        }
      }
