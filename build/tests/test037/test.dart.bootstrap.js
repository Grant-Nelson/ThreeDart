...
let modulePaths = {
 ...
 "web/tests/test037/test": "tests/test037/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test037/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test037__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test037/test.dart") {
          child.main();
          return true;
        }
      }
