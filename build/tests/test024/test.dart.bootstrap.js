...
let modulePaths = {
 ...
 "web/tests/test024/test": "tests/test024/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test024/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test024__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test024/test.dart") {
          child.main();
          return true;
        }
      }
