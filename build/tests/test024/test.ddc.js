define(['dart_sdk', 'web/common/checkGroup', 'packages/ThreeDart/src/Core/Bindable', 'packages/ThreeDart/src/Math/Color3', 'packages/ThreeDart/src/Events/Changable'], function(dart_sdk, checkGroup, Bindable, Color3, Changable) {
  ...
  const tests__test024__test = Object.create(_root);
  ...
  tests__test024__test.main = function() {
    let page = new common__common.ShellPage.new("Test 024");
    page.addLargeCanvas("testCanvas");
    page.addPar(JSArrayOfString().of(["Test of the Material Lighting shader with a simple spot light. ", "Use Ctrl plus the mouse to move the light."]));
    ...
    let spot = new src__Lights__Lights.Spot.new({mover: lightMover, color: src__Math__Math.Color3.white(), cutoff: 0.6, coneAngle: 0.5, attenuation0: 0.5, attenuation1: 0.05, attenuation2: 0.05});
  ...
  dart.trackLibraries("web/tests/test024/test.ddc", {
    "tests\\test024\\test.dart": tests__test024__test
  }, '{"version":3,"sourceRoot":"","sources":["test.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;AAYE,QAAiB,OAAO,IAAI,4BAAgB,CAAC;IAA5B,oBACE;IADF,YAEN,sBAAC,mEACR;IAHa,qBAIG,sBAAC;IAJJ,YAKN,sBAAC;AAEZ,QAAoB,KAAK,AAAI,gCAA0B,CAAC;AAExD,QAAa,aAAa,IAAI,6BAAY;IAA7B,eACL,AAAI,sCAAyB,CAAC,KAAK,KAAK,CAAC;IADpC,eAEL,IAAI,mCAAkB,SAAQ,EAAE,UAAU,QAAQ;AAE1D,QAAY,OAAO,IAAI,4BAAW,SAClB,UAAU,SACV,AAAI,4BAAiB,YACrB,gBACA,mBACA,mBACA,oBACA;AAEhB,QAAyB,OAAO,IAAI,6CAAwB;IAAnC,gBACV,IAAI;IADM,sBAEJ,AAAI,4BAAiB;IAFjB,qBAGL,AAAI,2BAAgB,CAAC;IAHhB,qBAIL,AAAI,2BAAgB,CAAC;IAJhB,sBAKJ,AAAI,2BAAgB,CAAC;IALjB,0BAMA;AAEzB,QAAiB,YAAY,IAAI,0BAAgB;IAAhC,kBACL,AAAO,0BAAM;AAEzB,QAAiB,OAAO,IAAI,0BAAgB;IAA3B,aACL,AAAI,kCAAqB,CAAC,KAAK,KAAK;IAD/B;cAEJ,AAAO,wBAAI;;;;AAExB,QAAa,WAAW,IAAI,6BAAY;IAA3B,aACP,IAAI,mCAAkB,SAAQ,EAAE,UAAU;IADnC,aAEP,AAAI,oCAAuB,CAAM,iBAAE;IAF5B,aAGP,AAAI,sCAAyB,CAAC,KAAK,KAAK;AAE9C,QAAiB,MAAM,IAAI,0BAAgB;IAA1B;cACJ,IAAI,6BAAY;YACT,AAAI,kCAAqB,CAAC,KAAK,KAAK;YACpC,UAAU;;;IAHb,YAIL,AAAO,4BAAQ,gBAAe,YAAY,eAAe;IAJpD;cAKA,IAAI,6CAAwB;yBACZ,AAAI,4BAAiB;;;AAEtD,MAAE,MAAM;cAAG,IAAI,kCAAiB;oBAChB,IAAI;qBACH,SAAS;qBACT,IAAI;qBACJ,GAAG;uBACD,QAAQ;;;AAE3B,gBAAI,6BAAiB,CAAC;UACd,QAAY;AAAK,eAAS,MAAM,GAAG,AAAO,wBAAI;;UAC9C,YAAY;AAAK,eAAS,MAAM,GAAG,AAAO,4BAAQ,SAAQ;;UAC1D,QAAY;AAAK,eAAS,MAAM,GAAG,AAAO,4BAAQ,aAAY,YAAY,YAAY;;UACtF,UAAY;AAAK,eAAS,MAAM,GAAG,AAAO,0BAAM,YAAW,cAAc;;UACzE,UAAY;AAAK,eAAS,MAAM,GAAG,AAAO,0BAAM;sBAAO;UACvD,QAAY;AAAK,eAAS,MAAM,GAAG,AAAO,wBAAI;;AAEtD,MAAE,WAAW,KAAK,CAAC,QAAC,CAAC;AACnB,MACE,AAAE,YAAO,CAAC,iBAAiB,QAAQ,GAAG,IAAI,iBAAiB,QAAM,CAAC;MAClE,AAAE,YAAO,CAAC,mBAAmB,QAAQ,GAAG,IAAI,mBAAmB,QAAM,CAAC;;AAE1E,IAAO,sBAAO,CAAC,EAAE;EACnB","file":"test.ddc.js"}');
  // Exports:
  return {
    tests__test024__test: tests__test024__test
  };
});
