...
let modulePaths = {
 ...
 "web/tests/test036/test": "tests/test036/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test036/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test036__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test036/test.dart") {
          child.main();
          return true;
        }
      }
