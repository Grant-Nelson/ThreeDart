...
let modulePaths = {
 ...
 "web/tests/test005/test": "tests/test005/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test005/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test005__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test005/test.dart") {
          child.main();
          return true;
        }
      }
