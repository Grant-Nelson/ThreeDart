...
let modulePaths = {
 ...
 "packages/OpenSimplexNoiseDart/OpenSimplexNoise": "packages/OpenSimplexNoiseDart/OpenSimplexNoise.ddc",
 "packages/ThreeDart/Data": "packages/ThreeDart/Data.ddc",
 "packages/ThreeDart/Events": "packages/ThreeDart/Events.ddc",
 "packages/ThreeDart/Input": "packages/ThreeDart/Input.ddc",
 "packages/ThreeDart/Lights": "packages/ThreeDart/Lights.ddc",
 "packages/ThreeDart/Math": "packages/ThreeDart/Math.ddc",
 "packages/ThreeDart/Movers": "packages/ThreeDart/Movers.ddc",
 "packages/ThreeDart/Scenes": "packages/ThreeDart/Scenes.ddc",
 "packages/ThreeDart/Shapes": "packages/ThreeDart/Shapes.ddc",
 "packages/ThreeDart/Techniques": "packages/ThreeDart/Techniques.ddc",
 "packages/ThreeDart/Textures": "packages/ThreeDart/Textures.ddc",
 "packages/ThreeDart/ThreeDart": "packages/ThreeDart/ThreeDart.ddc",
 "packages/ThreeDart/Tokenizer": "packages/ThreeDart/Tokenizer.ddc",
 "packages/ThreeDart/src/Collections/Collection": "packages/ThreeDart/src/Collections/Collection.ddc",
 "packages/ThreeDart/src/Core/Bindable": "packages/ThreeDart/src/Core/Bindable.ddc",
 "packages/ThreeDart/src/Events/Changable": "packages/ThreeDart/src/Events/Changable.ddc",
 "packages/ThreeDart/src/Input/Button": "packages/ThreeDart/src/Input/Button.ddc",
 "packages/ThreeDart/src/Math/Color3": "packages/ThreeDart/src/Math/Color3.ddc",
 "web/common/checkGroup": "common/checkGroup.ddc",
 "web/examples/craft/main": "examples/craft/main.ddc",
 "web/tests/test000/test": "tests/test000/test.ddc"
};
...
define("test.dart.bootstrap", ["web/tests/test000/test", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tests__test000__test.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tests/test000/test.dart") {
          child.main();
          return true;
        }
      }
    }
  dart_sdk.dart.trackLibraries("test.dart.bootstrap", {
    "test.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
