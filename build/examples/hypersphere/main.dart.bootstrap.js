...
let modulePaths = {
 ...
 "web/examples/hypersphere/main": "examples/hypersphere/main.ddc"
};
...
define("main.dart.bootstrap", ["web/examples/hypersphere/main", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.examples__hypersphere__main.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "examples/hypersphere/main.dart") {
          child.main();
          return true;
        }
      }
