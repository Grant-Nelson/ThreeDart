...
let modulePaths = {
 ...
 "packages/ThreeDart/IO": "packages/ThreeDart/IO.ddc",
 ...
 "web/examples/chess/main": "examples/chess/main.ddc"
};
...
define("main.dart.bootstrap", ["web/examples/chess/main", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.examples__chess__main.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "examples/chess/main.dart") {
          child.main();
          return true;
        }
      }
