...
let modulePaths = {
 ...
 "web/tutorials/tutorial1/main": "tutorials/tutorial1/main.ddc"
};
...
define("main.dart.bootstrap", ["web/tutorials/tutorial1/main", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  app.tutorials__tutorial1__main.main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "tutorials/tutorial1/main.dart") {
          child.main();
          return true;
        }
      }
