...
void main() {
  ...
  for (double x = -1.6; x <= 1.7; x += 0.8) {
    for (double y = -1.6; y <= 1.7; y += 0.8) {
      for (double z = -1.6; z <= 1.7; z += 0.8) {
        ...
        ThreeDart.Entity entity = new ThreeDart.Entity(shape: Shapes.cube())
  ...
  Techniques.MaterialLight colorTech = new Techniques.MaterialLight()
    ...
    ..lights.add(new Lights.Directional(
          ...
          color: new Math.Color3(0.2, 0.2, 0.3)))
  ...
  Scenes.RenderPass depthPass = new Scenes.RenderPass()
    ..camara = userCamara
    ..target = depthTarget
