...
void addMatrix2Tests(TestManager tests) {
  ...
  tests.add("Matrix2 Vector Transposition Test", (TestArgs args) {
    ...
    _matrix2String(args, mat, "[ 2.000,  3.000,",
                              "  4.000,  5.000]");
    _transVecMatrix2(args, mat,   0.0,  0.0,    0.0,  0.0);
    _transVecMatrix2(args, mat,   1.0,  0.0,    2.0,  4.0);
    _transVecMatrix2(args, mat,   0.0,  1.0,    3.0,  5.0);
    _transVecMatrix2(args, mat,   1.0,  1.0,    5.0,  9.0);
  });
...
void _transVecMatrix2(TestArgs args, Math.Matrix2 mat, double pntX, double pntY, double expX, double expY) {
  Math.Vector2 pnt = new Math.Vector2(pntX, pntY);
  Math.Vector2 exp = new Math.Vector2(expX, expY);
  Math.Vector2 result = mat.transVec2(pnt);
  if (result != exp) {
